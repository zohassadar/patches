    ...
    return (
        <>
                ...
                {active === 'colors' && (
                    <>
                        <p>
                            <button
                                onClick={() =>
                                    setNewTable(vanillaTable.slice())
                                }
                            >
                                Reset Defaults
                            </button>
                        ...
                        <p>
                            <button
                                onClick={() => setNewTable(prideTable.slice())}
                            >
                                Pride Colors
                            </button>
                        </p>
            ...
            */}
                        ...
                        {!!color && (
                            <p>
                                choose colour for level:{' '}
                                <strong>{level}</strong> colour:{' '}
                                <strong>{color}</strong>
                            </p>
                        )}
                        {!!color &&
